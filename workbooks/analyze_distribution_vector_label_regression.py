...
def _():
    ...
    from base.bit_sequences import ProbabilityVectorClassifierMLP
...
def _():
    array_output_dirs = [
        "/home/cg5763/data/oneshot_memorization/distribution-vector-label-regression-tidy-hoatzin",
    ]
